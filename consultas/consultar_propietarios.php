...
<div class="buscar"> Buscar: <input id="searchTerm" type="text" onkeyup="doSearch()" autocomplete="off" /></div>
 ...
 <table class="Tabla" id="buscar">
    ...
    <?php 
   $consulta = $conexion -> query("SELECT propietarios.* , casas.* FROM propietarios, casas, r_casa_propietarios WHERE propietarios.cedula = r_casa_propietarios.id_propietarios AND casas.id = r_casa_propietarios.id_casa ");
