...
<body>
	<div class="menu-lateral">
		...
		<div class="contenedor-items">
			<ul class='lista'>
				...
				<a href=""><li class="items-seleccionado"><img src="../imagenes/visitas.png" alt="Imagen de reservas"><p>Visitas</p></li></a>
			</ul>
		</div>
	...
	<div class="contenido-principal">
		...
		<div class="contenido">
			<iframe src="../consultas/consulta_visitas_administrador.php" frameborder="0"></iframe>
		</div>
	</div>
</body>
</html>
